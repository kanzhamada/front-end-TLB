	...
	<section class="relative z-10 py-20 md:py-32" id="about">
		<div class="container mx-auto px-4">
			...
			<div class="grid grid-cols-1 items-center gap-8 md:grid-cols-3 sm:grid-cols-2 md:gap-16">
				...
				>
					<div
						class="h-full w-full bg-[url('/IMG_3095.webp')] bg-cover bg-center transition-transform duration-700 group-hover:scale-110 group-active:scale-110 hover:grayscale-0 active:grayscale-0"
					></div>
				</div>
				<div
